...
#
# ebaz_linux.tcl: Tcl script for re-creating project 'ebaz_linux'
#
# Generated by Vivado on Thu Jan 11 22:27:04 MSK 2024
...
#
# 1. This project restoration tcl script (ebaz_linux.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/alex/Xilinx_prj/ebaz_linux/ebaz_linux.srcs/sources_1/new/pl_test.v"
#    "/home/alex/Xilinx_prj/ebaz_linux/ebaz_linux.srcs/constrs_1/imports/new/pins.xdc"
#    "/home/alex/Xilinx_prj/ebaz_linux/ebaz_linux.srcs/utils_1/imports/synth_1/design_top_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/ebaz_linux.srcs/sources_1/new/pl_test.v"]"\
 "[file normalize "$origin_dir/ebaz_linux.srcs/constrs_1/imports/new/pins.xdc"]"\
 "[file normalize "$origin_dir/ebaz_linux.srcs/utils_1/imports/synth_1/design_top_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "ebaz_linux"
...
set script_file "ebaz_linux.tcl"
...
set file "[file normalize ${origin_dir}/ebaz_linux.srcs/constrs_1/imports/new/pins.xdc]"
...
set file "synth_1/design_top_wrapper.dcp"
...
if { [get_files [list pl_test.v]] == "" } {
  import_files -quiet -fileset sources_1 /home/alex/Xilinx_prj/ebaz_linux/ebaz_linux.srcs/sources_1/new/pl_test.v
}


# Proc to create BD design_top
proc cr_bd_design_top { parentCell } {
...
\
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_ports LED_1]
  connect_bd_net -net pl_test_0_LED_2 [get_bd_pins pl_test_0/LED_2] [get_bd_ports LED_2]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/ACLK]
...
cr_bd_design_top ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files design_top.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files design_top.bd ] 
set_property IS_ENABLED "1" [get_files design_top.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files design_top.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files design_top.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files design_top.bd ] 
set_property PFM_NAME "" [get_files design_top.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files design_top.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files design_top.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files design_top.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files design_top.bd ] 
set_property USED_IN_SIMULATION "1" [get_files design_top.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files design_top.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list design_top.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/ebaz_linux.gen/sources_1/bd/design_top/hdl/design_top_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list design_top.bd]] -top]
...
set_property -name "incremental_checkpoint" -value "$proj_dir/ebaz_linux.srcs/utils_1/imports/synth_1/design_top_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ebaz_linux.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/ebaz_linux.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ebaz_linux.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
